...
import static gdg.com.gknm.utils.YjViewUtil.dip2px2;
...
//          throw new NullPointerException("You can add drawableRight attribute in XML");
      ...
      //  mClearDrawable.setBounds(0, 0, mClearDrawable.getIntrinsicWidth(), mClearDrawable.getIntrinsicHeight());
        mClearDrawable.setBounds(0, 0,dip2px2(getContext(),15), dip2px2(getContext(),15));
        //默认设置隐藏图标
    ...
    /**
     * 设置晃动动画 public static Animation shakeAnimation(int counts) {
