 ...
 */
public class SignLeaderPopWindow extends PopupWindow {
    ...
    public SignLeaderPopWindow(Context context) {
        this.mContext = context;
        LayoutInflater inflater = (LayoutInflater) context
                .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        conentView = inflater.inflate(R.layout.dialo_sign_alarm_leader, null);
