...
public class UploadUtil {
    ...
    public void uploadFile(final File file, final String fileKey,
      ...
      LogUtil.d( "请求的URL=" + RequestURL);
        LogUtil.d("请求的fileName=" + file.getName());
      LogUtil.d( "请求的fileKey=" + fileKey);
